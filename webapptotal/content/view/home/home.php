                            ...
                            <div class="col s12 m6 l4">
                                <div class="card">
                                    <div class="card-content  green white-text">
                                        <p class="card-stats-title"><i class="mdi-social-group"></i> Clients Identifiés</p>
                            ...
                            <div class="col s12 m6 l4">
                                <div class="card">
                                    <div class="card-content blue-grey white-text">
                                        ...
                                        <p class="card-stats-compare"><span class="blue-grey-text text-lighten-5">Avis Partagés</span>
                                        </p>
                                    </div>
                                    ...
                                    echo '<li class="collection-item">
                                        <div class="row">
                                            <div class="col s7">
                                                ...
                                                <p class="collections-content">'.$value['question'].'</p>
                                            </div>
                                            <div class="col s2">
                                                <span class="task-cat red accent-2">'.$value['score'].'</span>
                                            </div>
                                            <div class="col s3">
                                                <div class="progress">
