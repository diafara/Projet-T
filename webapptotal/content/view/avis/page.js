$(function(){
    ...
    $('#addPage').on('submit', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "php/Controller/page.php", //process to mail
            data: formData,
            ...
            success: function(msg){
                if(parseInt(msg)==1){
                    UIkit.modal.alert('<p class="uk-text-bold"><i class="uk-icon-check uk-icon-large uk-text-success"> </i> La page a été ajoutée avec succès</p>');
...
//                      UIkit.modal.alert('<p class="uk-text-bold"><i class="uk-icon-check uk-icon-large uk-text-success"> </i> L page a été ajoutée avec succès</p>');
//                     altair_helpers.content_preloader_hide();
//                     $(document).click(function(){
...
//                      UIkit.modal.alert('<p class="uk-text-bold"><i class="uk-icon-check uk-icon-large uk-text-success"> </i> L page a été modifiée avec succès</p>');
//                     altair_helpers.content_preloader_hide();
//                     $(document).click(function(){
// 			            window.location.href = "page";
//                     });
