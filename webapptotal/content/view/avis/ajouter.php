...
<script type="text/javascript" src="assets/js/ajax.js"></script>
    <script type="text/javascript" src="php/view/page/page.js"></script>
       <div id="page_content">
            ...
            <div class="md-card">
                <div class="md-card-content">
                    ...
                    <div class="uk-overflow-container uk-margin-bottom">
                        <form method="post" action="" class="addnew" id="addPage">
                            ...
                            <div class="uk-grid">
                                <div class="uk-width-medium-1-2">
                                    <select id="select_demo_1" class="md-input" name="idSousmenu" id="idSousmenu">
                                        <option value="" disabled selected hidden>Sous menu </option>
                                        <?php
                                           require('php/classes/classeSousmenu.php');
                                           $page = new Sousmenu();
                                           $list = $page->listSousmenu();
                                           foreach($list as $value){
                                               echo '
                                                        <option value="'.$value['idSousmenu'].'">'.$value['page'].'</option>
                                                    ';
                                           }
                                        ?>
                                    </select>
